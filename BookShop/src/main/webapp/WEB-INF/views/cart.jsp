							...
							<div class="prod_box">
								...
								<div class="center_prod_box">
									...
									<div class="prod_count">
										<span class="info">Count in stock:</span> <span class="blue"><c:out
												value="${listCart.count_book}" /></span> <input type="hidden"
											name="count_in_stock" value="${listCart.count_book}"
											size="1px">
									</div>
									<div class="prod_count">
										<span class="info">Count order:</span> <span class="blue">
											 
											<c:out 	value="${listCart.count_cart}" />
										</span>
									</div>
									<div class="prod_button">
										<a href="<c:url value="cart"><c:param name="id_cart" value="${listCart.id_cart}"/></c:url>">Make Order</a>
